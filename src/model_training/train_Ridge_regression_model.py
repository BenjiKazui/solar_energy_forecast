...
# no added features: MAE 174
# only added time_based_features: MAE 217
# only added sun_position_features: MAE 226
# time + sun_position features: MAE 267
...
# changing alpha doenst change too the MAE a lot
...
#joblib.dump(model_lr, "C:/Users/Brudo/solar_energy_forecast/models/Ridge_regression_model.pkl")

...
# no added features: MAE 160
# only added time_based_features: MAE 187
# only added sun_position_features: MAE 156
# time + sun_position features: MAE 169
# time + sun + lag: MAE 169
# time + sun + lag + interaction: MAE 169
# lag + interaction: MAE 164
# only lag: MAE 160
# only interaction: MAE 164
# time + lag + interaction: MAE 176
# lag + sun + interaction: MAE 156 -> 127 (max_depth=5) -> 124 (max_depth=7) -> 131 (max_depth=10)
...
model_lr = DecisionTreeRegressor(max_depth=10, random_state=42)
...
#joblib.dump(model_lr, "C:/Users/Brudo/solar_energy_forecast/models/Decision_Tree_regression_model.pkl")
